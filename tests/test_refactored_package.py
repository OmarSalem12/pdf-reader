...
class TestPDFReaderPackage(unittest.TestCase):
    ...
    def test_extract_nonexistent_field(self):
        ...
        result = self.extractor.extract_specific_field(
            test_text, "nonexistent"
        )
    ...
    def test_pdf_reader_with_config_file(self):
    ...
    def test_pdf_reader_process_pdf(self):
    ...
    def test_pdf_reader_get_methods(self):
